...
function MemberRow({
  ...
  const nameClass = large
    ? "font-sans text-2xl font-bold leading-snug tracking-tight text-navy md:text-3xl"
    : "font-sans text-xl font-bold leading-snug tracking-tight text-navy";

  const content = (
    <>
      <p className="font-mono text-[0.65rem] font-bold uppercase tracking-[0.14em] text-red lg:col-span-4">
        {member.role}
      ...
      <div className="lg:col-span-2 lg:text-right">
        {member.linkedin ? (
          <span className="font-mono text-[0.65rem] font-bold uppercase tracking-[0.14em] text-navy transition-colors duration-150 group-hover:text-red">
            LinkedIn
          </span>
        ) : (
          <span className="font-mono text-[0.65rem] font-bold uppercase tracking-[0.14em] text-neutral-400">
            TBA
          </span>
        )}
      </div>
  ...
  if (member.linkedin) {
    return (
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="group grid grid-cols-1 gap-2 py-6 lg:grid-cols-12 lg:items-baseline lg:gap-8"
      >
        {content}
      </a>
    );
  ...
  return (
    <div className="grid grid-cols-1 gap-2 py-6 lg:grid-cols-12 lg:items-baseline lg:gap-8">
      {content}
    </div>
  );
}
